...
int LiStartConnection(PCONNECTION_LISTENER_CALLBACKS clCallbacks,
    PDECODER_RENDERER_CALLBACKS drCallbacks, void* renderContext, int drFlags) {
    int err;
    ...
    fixupMissingCallbacks(&drCallbacks, &clCallbacks);
